...
public interface SystemOAuth2GrantService {
     ...
     * @return 访问令牌
     */
    SystemOAuth2AccessTokenDomain password(String username, String password, String clientId, List<String> scopes, Integer accessTokenValiditySeconds, Integer refreshTokenValiditySeconds);
