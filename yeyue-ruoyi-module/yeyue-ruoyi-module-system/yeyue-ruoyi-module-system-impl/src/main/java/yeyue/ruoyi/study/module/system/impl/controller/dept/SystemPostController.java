...
public class SystemPostController {
    ...
    @PutMapping("/create")
    public CommonResult<Long> create(@Validated({CommandGroup.Create.class}) @RequestBody SystemPostCreateReqDTO dto) {
        return CommonResult.success(service.create(dto));
    }

    @ApiOperation(value = "修改系统岗位")
    @PostMapping("/update")
    public CommonResult<Void> update(@Validated({CommandGroup.Update.class}) @RequestBody SystemPostUpdateReqDTO dto) {
        service.update(dto);
    ...
    @PostMapping("/list")
    public CommonResult<PageResult<SystemPostDomain>> get(@Validated({CommandGroup.List.class}) @RequestBody SystemPostPageReqDTO dto) {
