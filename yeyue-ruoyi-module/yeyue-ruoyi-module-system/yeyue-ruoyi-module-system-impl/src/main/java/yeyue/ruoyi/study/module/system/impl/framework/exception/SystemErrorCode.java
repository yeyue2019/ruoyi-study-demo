...
public enum SystemErrorCode implements ErrorCode {
    ...
    DEPT_PARENT_NOT_EXITS("10005", "父级部门不存在"),
    DEPT_NOT_ENABLE("10006", "部门不处于开启状态，不允许选择"),
    DEPT_NAME_DUPLICATE("10007", "已经存在该名字的部门"),
    DEPT_EXITS_CHILDREN("10008", "存在子部门，无法删除"),
    MENU_PARENT_NOT_EXISTS("10009", "父菜单不存在"),
    MENU_NOT_EXISTS("10010", "菜单不存在"),
    MENU_PARENT_NOT_DIR_OR_MENU("10011", "父菜单的类型必须是目录或者菜单"),
    MENU_NAME_DUPLICATE("10012", "已经存在该名字的菜单"),
    MENU_EXISTS_CHILDREN("10013", "存在子菜单，无法删除"),
